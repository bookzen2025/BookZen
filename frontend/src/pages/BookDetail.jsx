  ...
  return (
    <section className="max-padd-container min-h-screen">
      <div className="pt-28 pb-16">
        {/* Book Info Section with Sticky Behavior */}
        <div className="relative"> {/* Container chính với position relative */}
          <div className="flex flex-col md:flex-row gap-8 lg:gap-16">
            {/* Book Image Container - Sẽ trở thành sticky */}
            <div className="w-full md:w-1/3 md:h-[calc(100vh-8rem)]" style={{ position: 'sticky', top: '7rem' }}>
              <div className="flex h-full items-start">
                <div className="bg-primary p-6 rounded-3xl relative group shadow-lg hover:shadow-xl transition-all duration-300">
