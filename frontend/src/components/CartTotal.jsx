    ...
    return (
        <div className='w-full'>
            ...
            <div className='flexBetween pt-3'>
                ...
                <p className='h5'>{currency}{getCartAmount().toLocaleString('vi-VN')}</p>
            </div>
            <hr className='mx-auto h-[1px] w-full bg-gray-900/10 my-1' />
            <div className='flexBetween pt-3'>
                <h5 className='h5'>Shipping Fee:</h5>
                <p className='h5'>{getCartAmount() === 0 ? "0" : `${currency}${delivery_charges.toLocaleString('vi-VN')}`}</p>
            </div>
            <hr className='mx-auto h-[1px] w-full bg-gray-900/10 my-1' />
            <div className='flexBetween pt-3'>
                <h5 className='h5'>Total:</h5>
                <p className='h5'>{currency}{getCartAmount() === 0 ? "0" : (getCartAmount() + delivery_charges).toLocaleString('vi-VN')}</p>
            </div>
            <hr className='mx-auto h-[1px] w-full bg-gray-900/10 my-1' />
        </div>
    )
