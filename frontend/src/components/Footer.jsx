  ...
  return (
    <footer className='mb-4'>
      <div className='rounded-tr-3xl rounded-tl-3xl pt-12 xl:pt-20 pb-8'>
        <h3 className='h3'>Khám phá những cuốn sách thắp sáng trí tưởng tượng của bạn</h3>
        <p>Chúng tôi mang đến cho bạn những cuốn sách hay nhất từ các tác giả nổi tiếng trên thế giới.</p>
        ...
        <div className='flex justify-between flex-wrap gap-2'>
          <div className='max-w-sm'>
            ...
            <p className='py-4'>BookZen - Nơi bạn có thể tìm thấy những cuốn sách hay nhất, phù hợp với sở thích và nhu cầu của mình.</p>
            <div className='flexBetween pl-3 h-[3rem] bg-primary w-full max-w-[333px] rounded-full ring-1 ring-slate-500/5 mb-4'>
              ...
              <button className='btn-secondaryOne relative right-[24px]'>Đăng ký</button>
            </div>
          </div>
      ...
      {/* copyrights */}
      <p className='text-white bg-tertiary medium-14 py-2 px-8 rounded flexBetween '><span>2025 BookZen</span><span>Đã đăng ký bản quyền</span></p>
    </footer>
  )
}
