...
export const books = [
    ...
    {
        _id: "1",
        name: "Cuộc Đào Thoát Vĩ Đại",
        image: book_1,
        price: 15,
        description: "Đắm chìm trong câu chuyện phiêu lưu và lòng dũng cảm đầy hấp dẫn.",
...
export const FOOTER_LINKS = [
  ...
  export const FOOTER_CONTACT_INFO = {
    ...
    links: [
      ...
      { label: "Email", value: "info@BookZen.com" },
    ],
  };
